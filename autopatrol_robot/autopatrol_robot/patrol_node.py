...
class PatrolNode(BasicNavigator):
    ...
    def nav_to_pose(self, target_pose):
        ...
        elif result == TaskResult.CANCELED:self.get_logger().warn(' 导航结果：被取消 ')
        elif result == TaskResult.FAILED:self.get_logger().info(' 导航结果：失败 ')
        else:self.get_logger().info(' 导航结果：返回状态无效 ')
